...
/**
 * Servlet implementation class AddCakeImgServlet
 */
@WebServlet("/AddCakeImg")
public class AddCakeImgServlet extends HttpServlet {
	private static final long serialVersionUID = 1L;

	/**
	 * @see HttpServlet#HttpServlet()
	 */
	public AddCakeImgServlet() {
		super();
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response)
		...
		this.getServletContext().setAttribute("img", cakeImgPath);
